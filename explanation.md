This app is designed to be used by SI staff to calculate their COVID risk level when working on-site. The user can choose to input different parameters depending on:
